...
public class SAXExtensionDocsParser implements ExtensionDocsParser {
    ...
    @Override
    public ExtensionInfo parse(final InputStream inputStream) {
        ...
        try {
            ...
            return handler.getExtensionInfo();
    ...
    private static class ExtensionDocsHandler extends DefaultHandler {
        ...
        private ProvidedServiceAPI.Builder providedApiBuilder;
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            ...
            switch(currElement) {
                case EXTENSION:
                    ...
                    break;
                case SERVICE:
                    providedApiBuilder = new ProvidedServiceAPI.Builder();
                    break;
                default:
                    break;
            }
            ...
            switch(currElement) {
                ...
                case REQUIRED_PERMISSION:
                    if (ExtensionDocsElement.RESTRICTION.getElementName().equals(prevElementName)) {
                        extensionDetailsBuilder.restricted(true);
                    }
                    break;
                case CLASS_NAME:
                ...
                case VERSION:
                    ...
                    break;
                case SERVICE:
                    final ProvidedServiceAPI providedServiceApi = providedApiBuilder.build();
        ...
        public ExtensionInfo getExtensionInfo() {
            return new ExtensionInfo(nifiApiVersion, extensionDetails);
        }
    }
