...
public class ProvidedServiceAPI {
    ...
    private ProvidedServiceAPI(final Builder builder) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ProvidedServiceAPI)) {
            return false;
        }

        final ProvidedServiceAPI other = (ProvidedServiceAPI) obj;
    ...
    public static class Builder {
        ...
        public ProvidedServiceAPI build() {
            return new ProvidedServiceAPI(this);
        }
