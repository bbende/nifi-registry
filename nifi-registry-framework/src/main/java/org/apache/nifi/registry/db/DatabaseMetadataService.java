...
public class DatabaseMetadataService implements MetadataService {
    ...
    public List<BucketEntity> getBucketsByName(final String name) {
        ...
        final Iterable<BucketEntity> retrievedBuckets = bucketRepository.findByName(name);
    ...
    @Override
    public Set<BucketEntity> getBuckets(final QueryParameters params) {
    ...
    private Set<BucketEntity> getAllBuckets() {
        final Set<BucketEntity> buckets = new LinkedHashSet<>();
    ...
    private Set<BucketEntity> getPagedBuckets(final QueryParameters params) {
    ...
    private Set<BucketEntity> getSortedBuckets(final QueryParameters params) {
    ...
    @Override
    public Set<BucketItemEntity> getBucketItems(final QueryParameters params) {
        if (params.getNumRows() != null && params.getPageNum() != null) {
    ...
    private Set<BucketItemEntity> getAllBucketItems() {
        final Set<BucketItemEntity> bucketItems = new LinkedHashSet<>();
    ...
    private Set<BucketItemEntity> getPagedBucketItems(final QueryParameters params) {
        final Pageable pageable = getPageRequest(params);
        final Set<BucketItemEntity> items = new LinkedHashSet<>();
    ...
    private Set<BucketItemEntity> getSortedBucketItems(final QueryParameters params) {
        final Sort sort = getSort(params);
        final Set<BucketItemEntity> items = new LinkedHashSet<>();
    ...
    @Override
    public Set<BucketItemEntity> getBucketItems(final QueryParameters params, final BucketEntity bucket) {
        if (params.getNumRows() != null && params.getPageNum() != null) {
    ...
    private Set<BucketItemEntity> getBucketItems(final BucketEntity bucket) {
        final Set<BucketItemEntity> bucketItems = new LinkedHashSet<>();
    ...
    private Set<BucketItemEntity> getPagedBucketItems(final QueryParameters params, final BucketEntity bucket) {
        final Pageable pageable = getPageRequest(params);
        final Set<BucketItemEntity> items = new LinkedHashSet<>();
    ...
    private Set<BucketItemEntity> getSortedBucketItems(final QueryParameters params, final BucketEntity bucket) {
        final Sort sort = getSort(params);
        final Set<BucketItemEntity> items = new LinkedHashSet<>();
    ...
    public List<FlowEntity> getFlowsByName(final String name) {
        ...
        final Iterable<FlowEntity> retrievedFlows = flowRepository.findByName(name);
    ...
    @Override
    public Set<FlowEntity> getFlows(final QueryParameters params) {
        if (params.getNumRows() != null && params.getPageNum() != null) {
    ...
    private Set<FlowEntity> getAllFlows() {
    ...
    private Set<FlowEntity> getPagedFlows(final QueryParameters params) {
        final Pageable pageable = getPageRequest(params);
        final Set<FlowEntity> flows = new LinkedHashSet<>();
    ...
    private Set<FlowEntity> getSortedFlows(final QueryParameters params) {
        final Sort sort = getSort(params);
        final Set<FlowEntity> flows = new LinkedHashSet<>();
