...
public class ItemResource {
    ...
    @Autowired
    public ItemResource(final RegistryService registryService) {
    ...
    public Response getItems(@QueryParam("sort") final List<SortParameter> sortParameters) {
        ...
        final Set<BucketItem> items = registryService.getBucketItems(params);
    ...
    public Response getItems(@PathParam("bucketId") final String bucketId, @QueryParam("sort") final List<SortParameter> sortParameters) {

        final QueryParameters params = new QueryParameters.Builder()
                .addSorts(sortParameters)
                .build();

        final Set<BucketItem> items = registryService.getBucketItems(params, bucketId);
        return Response.status(Response.Status.OK).entity(items).build();
    }
